            ...
            if k["path"]!=path:
                ...
                if k["attacked"]>0:
                    ...
                    if len(anon_sets)>1:
                        ...
                        # if len(dests_comp) == 4791 or len(dests_comp) == 0:
                        #     print(k["path"])
...
print(dest_count_comp)
print(dest_count_incomp)
print(source_count_comp)
print(source_count_incomp)
